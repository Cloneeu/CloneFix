# Todo el Codigo de la Version 3
...
<body>
  ...
  <header id="hero" class="hero bg-black">
    <div class="container">
      <h1 id="heroTitle" class="display-5 fw-bold text-white"></h1>
      <p id="heroDesc" class="lead col-lg-6 text-white"></p>
...
const renderRow = (title, shows) => {
  ...
  section.classList = "mb-3 text-white"
  section.innerHTML = `
  ...
  modalBody.innerHTML = `
    <div class="row g-4">
      ...
      <div class="col-md-8">
        ...
        <p class="text-secondary small">${show.summary || "Sin Sinopsis"}</p>
